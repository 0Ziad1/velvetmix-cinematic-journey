...
export function ProductSection({
  ...
  useGSAP(
    () => {
       ...
       *
       * No blur is used here.
       * The image stays sharp throughout the animation.
       */
      gsap.fromTo(
        ".p-visual",
        {
          ...motionFrom[product.motion],
        },
        {
    ...
    >
      ...
      <div className="relative mx-auto grid w-full max-w-[1400px] items-center gap-12 px-5 sm:px-8 lg:grid-cols-2 lg:gap-20">
        ...
        <div className={index % 2 === 1 ? "lg:order-1" : ""}>
          ...
          <div className="p-reveal mt-8">
            <p className="eyebrow">
              {t("label.characteristics")}
            </p>

            <ul className="mt-3 space-y-2">
              {copy.characteristics.map((characteristic) => (
                <li
                  key={characteristic}
